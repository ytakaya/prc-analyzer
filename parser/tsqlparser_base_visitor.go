...
func (v *BaseTSqlParserVisitor) VisitGo_batch_statement(ctx *Go_batch_statementContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseTSqlParserVisitor) VisitDbcc_special(ctx *Dbcc_specialContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseTSqlParserVisitor) VisitDbcc_command(ctx *Dbcc_commandContext) interface{} {
	return v.VisitChildren(ctx)
}
