...
type TSqlParserListener interface {
	...
	// EnterGo_batch_statement is called when entering the go_batch_statement production.
	EnterGo_batch_statement(c *Go_batch_statementContext)
	...
	// EnterDbcc_command is called when entering the dbcc_command production.
	EnterDbcc_command(c *Dbcc_commandContext)
	...
	// EnterNull_or_default is called when entering the null_or_default production.
	EnterNull_or_default(c *Null_or_defaultContext)
	...
	// ExitGo_batch_statement is called when exiting the go_batch_statement production.
	ExitGo_batch_statement(c *Go_batch_statementContext)
	...
	// ExitDbcc_command is called when exiting the dbcc_command production.
	ExitDbcc_command(c *Dbcc_commandContext)
	...
	// ExitNull_or_default is called when exiting the null_or_default production.
	ExitNull_or_default(c *Null_or_defaultContext)
