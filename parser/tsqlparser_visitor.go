...
type TSqlParserVisitor interface {
	...
	// Visit a parse tree produced by TSqlParser#go_batch_statement.
	VisitGo_batch_statement(ctx *Go_batch_statementContext) interface{}
	...
	// Visit a parse tree produced by TSqlParser#dbcc_special.
	VisitDbcc_special(ctx *Dbcc_specialContext) interface{}

	// Visit a parse tree produced by TSqlParser#dbcc_clause.
	VisitDbcc_clause(ctx *Dbcc_clauseContext) interface{}

	// Visit a parse tree produced by TSqlParser#dbcc_command.
	VisitDbcc_command(ctx *Dbcc_commandContext) interface{}
